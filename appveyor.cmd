...
if "%perl_type%" == "cygwin" (
  cinst -y wget
  wget https://cygwin.com/setup-x86_64.exe -O C:\cygwin64\setup-x86_64.exe
  start /wait c:\cygwin64\setup-x86_64.exe --no-check-certificate -qgnNdO -l C:\cygwin64\var\cache\setup -R c:\cygwin64 -s http://mirror.steadfast.net/cygwin/ -P openssl-devel -P perl -P make -P gcc -P gcc-g++ -P libcrypt-devel
